 ...
 *
 * @author Greg Priday <greg@distinctivethemes.com>
 * @copyright Copyright (c) 2011, Greg Priday
 * @license GPL <http://www.gnu.org/copyleft/gpl.html>
 */
class DistinctiveThemes_Color_Object extends DistinctiveThemes_Color{
	private $changed;
	 ...
	 */
	public static function distance(DistinctiveThemes_Color_Object $c1, DistinctiveThemes_Color_Object $c2){
		return sqrt(
