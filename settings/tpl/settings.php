<div class="wrap" id="panels-settings-page">
	<div class="settings-banner">
		...
		<h1><?php _e('Distinctive Themes Widget Page Builder - based on DistinctiveThemess', 'distinctivethemes-panels') ?></h1>

		<div id="panels-settings-search">
			<input type="search" placeholder="<?php esc_attr_e('Search Settings', 'distinctivethemes-panels') ?>" />
	...
	<?php if( $this->settings_saved ) : ?>
		<div id="setting-error-settings_updated" class="updated settings-error">
			<p><strong><?php _e('Settings Saved', 'distinctivethemes-panels') ?></strong></p>
		</div>
	<?php endif; ?>
	...
	<form action="<?php echo admin_url('options-general.php?page=distinctivethemes_panels') ?>" method="post" >
		...
		<div class="submit">
			...
			<input type="submit" value="<?php _e('Save Settings', 'distinctivethemes-panels') ?>" class="button-primary" />
		</div>
	</form>
