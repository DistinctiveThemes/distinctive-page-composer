	...
	render: function () {
		...
		_.each( panelsOptions.widgets, function ( widget ) {
			...
			if ( _.isUndefined( widget.icon ) ) {
				var str = widget.title.replace(/[_\W]+/g, "-")
				var res = str.toLowerCase();
				var newStr = res.substring(0, res.indexOf('distinctivethemes') + 'distinctivethemes'.length);

				widget.icon = 'dashicons dashicons-admin-generic';
			}

			$( '<span class="widget-icon '+ newStr +'" />' ).addClass( widget.icon ).prependTo( $w.find( '.widget-type-wrapper' ) );
