/**
 * @copyright Greg Priday - <https://distinctivethemes.com/>
 * @license GPL 3.0 http://www.gnu.org/licenses/gpl.html
 */

( function( $ ){

	$.fn.distinctivethemesParallax = function( options ){
		...
		var setupParallax = function( ){
			try {
				...
				if( $$.data('distinctivethemes-parallax-init') === undefined ) {
...
jQuery( function( $ ){
	$('[data-distinctivethemes-parallax]' ).each( function(){
		$( this ).distinctivethemesParallax( $( this ).data('distinctivethemes-parallax') );
	} );
} );
