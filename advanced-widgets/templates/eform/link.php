...
$link = dapper_cl_parse_link_value( $value );
...
$output .= '<a class="cl-linkdialog-btn button button-default button-large" href="javascript:void(0)">' . __( 'Insert link', 'dapper-pro' ) . '</a>';
