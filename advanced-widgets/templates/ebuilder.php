...
<div class="cl-ebuilder">
	<div class="cl-ebuilder-header">
		<div class="cl-ebuilder-title"<?php echo dapper_cl_pass_data_to_js($titles) ?>></div>
		<div class="cl-ebuilder-closer">&times;</div>
	</div>
	<div class="cl-ebuilder-body"><?php echo $body ?></div>
	<div class="cl-ebuilder-footer">
		<div class="cl-ebuilder-btn for_close button"><?php _e( 'Close', 'dapper-pro' ) ?></div>
		<div class="cl-ebuilder-btn for_save button button-primary"><?php _e( 'Save changes', 'dapper-pro' ) ?></div>
	</div>
</div>
