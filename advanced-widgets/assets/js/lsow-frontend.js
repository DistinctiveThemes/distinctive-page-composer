...
if (typeof (jQuery) != 'undefined') {
    ...
    (function ($) {
        ...
        $(function () {
            ...
            var DistinctiveThemes_LSOW_Frontend = {
                ...
                setup_parallax: function () {
                    ...
                    function init_parallax() {
                        ...
                        if (DistinctiveThemes_LSOW_Frontend.isMobile() === false) {
                            ...
                            $('.lsow-section-bg-parallax').each(function () {
                                ...
                                if (boundingRect.bottom >= 0 && boundingRect.top <= windowHeight) {
                                    ...
                                    segment.find('.lsow-parallax-bg').css('-' + DistinctiveThemes_LSOW_Frontend.vendor_prefix() + '-transform', 'translate3d(0px, ' + transformPercent + '%, 0px)');
                                }
                            });
                        }
            ...
            DistinctiveThemes_LSOW_Frontend.init();
