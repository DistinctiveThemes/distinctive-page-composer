...
(function($){
    ...
    $.fn.sowSetupForm = function() {
        ...
        return $(this).each( function(i, el){
            ...
            $('.siteorigin-widget-field-your_icon').hide();
            var ourValue = $('.siteorigin-widget-field-your_icon input').val();
            $('.siteorigin-widget-icon-selector-current span').addClass(ourValue);            
            ...
            $fields.filter('.siteorigin-widget-field-type-icon').each(function(){
                ...
                var rerenderIcons = function(){
                    ...
                    for ( var i in iconWidgetCache[family].icons ) {
                        ...
                        var icon = $('<div data-dapper-sow-icon="' + i +'"/>')
                            .attr('data-value', i)
                            .addClass( 'dapper-sow-icon-' + family + ' ' + family + '-' + i)
                            .addClass( 'siteorigin-widget-icon-icons-icon ' + family + '-' + i )
                            .click(function(){

                        //var icon = $('<div data-dapper-sow-icon="' + family + '-' + i +  '"/>')
                            //.addClass( 'dapper-sow-icon ' + family + '-' + i)
                            //.addClass( 'siteorigin-widget-icon-icons-icon' + family + '-' + i )
                            //.click(function(){
                                ...
                                if( $$.hasClass('siteorigin-widget-active') ) {
                                    ...
                                    $b.find('span')
                                        ...
                                        .attr( 'class', '' )
                                        .addClass( 'dapper-sow-icon-' + ourIcon[0]['value'] );

                                    $('.siteorigin-widget-field-your_icon input').val(ourIcon[0]['value']);
                                }
                                $v.trigger('change');
                        ...
                        if( $v.val() === family + '-' + i ) {
							...
							$b.find('span')
								...
								.attr( 'class', i )
								.addClass( 'dapper-sow-icon-' + icon.attr('data-dapper-sow-icon') );
                            icon.addClass('siteorigin-widget-active');
                        }
                    }

                    $('.siteorigin-widget-icon-selector').find("[data-value='" + ourValue + "']").addClass('siteorigin-widget-active');
