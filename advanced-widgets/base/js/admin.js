...
(function($){
    ...
    $.fn.sowSetupForm = function() {
        ...
        return $(this).each( function(i, el){
            ...
            if( $el.is('.siteorigin-widget-form-main') ) {
                if( $el.data('dapper-sow-form-setup') === true ) {
                    return true;
                }
            ...
            formId = $mainForm.find('> .dapper-widgets-form-id').val();
            ...
            $fields.filter('.siteorigin-widget-field-type-icon').each(function(){
                ...
                var rerenderIcons = function(){
                    ...
                    for ( var i in iconWidgetCache[family].icons ) {
                        ...
                        var icon = $('<div data-dapper-sow-icon="' + iconWidgetCache[family].icons[i] +  '"/>')
                            .attr('data-value', family + '-' + i)
                            .addClass( 'dapper-sow-icon-' + family )
                            ...
                            .click(function(){
                                ...
                                if( $$.hasClass('siteorigin-widget-active') ) {
                                    ...
                                    $b.find('span')
                                        .show()
                                        .attr( 'data-dapper-sow-icon', $$.attr('data-dapper-sow-icon') )
                                        .attr( 'class', '' )
                                        .addClass( 'dapper-sow-icon-' + family );
                                }
                                $v.trigger('change');
                        ...
                        if( $v.val() === family + '-' + i ) {
							...
							$b.find('span')
								.show()
								.attr( 'data-dapper-sow-icon', icon.attr('data-dapper-sow-icon') )
								.attr( 'class', '' )
								.addClass( 'dapper-sow-icon-' + family );
                ...
                var changeIconFamily = function(){
                    ...
                    if(typeof iconWidgetCache[family] === 'undefined') {
                        $.getJSON(
                            soWidgets.ajaxurl,
                            { 'action' : 'distinctivethemes_widgets_get_icons', 'family' :  $is.find('select.siteorigin-widget-icon-family').val() },
                            function(data) {
            ...
            $el.trigger( 'sowsetupform', $fields ).data('dapper-sow-form-setup', true);
    ...
    $.fn.sowSetupPreview = function(){
        ...
        previewButton.find('> a').click(function(e){
            ...
            var modal = $( $('#dapper-so-advanced-widgets-tpl-preview-dialog').html().trim() ).appendTo('body');
