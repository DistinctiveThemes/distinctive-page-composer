...
class DistinctiveThemes_SiteOrigin_Widget_Meta_Box_Manager extends DistinctiveThemes_SiteOrigin_Widget {

	const POST_META_KEY = 'dapper-widgets-post-meta';
	 ...
	 *
	 * @return DistinctiveThemes_SiteOrigin_Widget_Meta_Box_Manager
	 */
	static function single(){
		static $single = false;
		if( empty($single) ) $single = new DistinctiveThemes_SiteOrigin_Widget_Meta_Box_Manager();
	...
	public function __construct() {
		parent::__construct(
			'dapper-sow-meta-box-manager',
			__( 'DistinctiveThemes: Meta Box Manager', 'dapper-pro'),
			array(
				'has_preview' => false,
				'help' => 'https://siteorigin.com/docs/advanced-widgets/advanced-concepts/widget-post-meta-box-forms/'
			),
			array(),
			array()
		);
	...
	public function add_meta_boxes( $post_type ) {
		...
		if ( !empty( $this->form_options ) ) {
			add_meta_box(
				'dapper-widgets-meta-box',
				__( 'Widgets Bundle Post Meta Data', 'dapper-pro' ),
