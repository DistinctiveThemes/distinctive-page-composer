 ...
 */
class DistinctiveThemes_SiteOrigin_Widgets_Color {
	/**
 ...
 */
class DistinctiveThemes_SiteOrigin_Widgets_Color_Object extends DistinctiveThemes_SiteOrigin_Widgets_Color{
	private $changed;
	 ...
	 */
	public static function distance(DistinctiveThemes_SiteOrigin_Widgets_Color_Object $c1, DistinctiveThemes_SiteOrigin_Widgets_Color_Object $c2){
		return sqrt(
