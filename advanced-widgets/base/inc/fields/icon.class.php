...
/**
 * Class DistinctiveThemes_SiteOrigin_Widget_Field_Icon
 */
class DistinctiveThemes_SiteOrigin_Widget_Field_Icon extends DistinctiveThemes_SiteOrigin_Widget_Field_Base {
	...
	protected function render_field( $value, $instance ) {
		...
		<div class="siteorigin-widget-icon-selector-current">
			...
			<label><?php _e('Choose Icon', 'dapper-pro') ?></label>
		</div>
