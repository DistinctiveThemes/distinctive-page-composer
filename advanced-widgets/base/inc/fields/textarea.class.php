...
/**
 * Class DistinctiveThemes_SiteOrigin_Widget_Field_Textarea
 */
class DistinctiveThemes_SiteOrigin_Widget_Field_Textarea extends DistinctiveThemes_SiteOrigin_Widget_Field_Text_Input_Base {
	/**
