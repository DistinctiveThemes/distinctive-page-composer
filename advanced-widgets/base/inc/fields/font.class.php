...
/**
 * Class DistinctiveThemes_SiteOrigin_Widget_Field_Font
 */
class DistinctiveThemes_SiteOrigin_Widget_Field_Font extends DistinctiveThemes_SiteOrigin_Widget_Field_Base {

	protected function render_field( $value, $instance ) {
		static $widget_font_families;
		if( empty($widget_font_families) ) {

			$widget_font_families = distinctivethemes_widgets_font_families();
		}
		?>
		<div class="siteorigin-widget-font-selector siteorigin-widget-field-subcontainer">
			<select name="<?php echo esc_attr( $this->element_name ) ?>" id="<?php echo esc_attr( $this->element_id ) ?>" class="siteorigin-widget-input">
				<option value="default" selected="selected"><?php esc_html_e( 'Use theme font', 'dapper-pro' ) ?></option>
