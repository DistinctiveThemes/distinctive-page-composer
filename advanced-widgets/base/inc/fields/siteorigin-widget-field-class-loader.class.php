 ...
 *
 * Class DistinctiveThemes_SiteOrigin_Field_Class_Loader
 */
class DistinctiveThemes_SiteOrigin_Widget_Field_Class_Loader {
	...
	function __construct(){
		...
		$this->add_class_prefixes( array( 'DistinctiveThemes_SiteOrigin_Widget_Field_' ), 'base' );
	...
	static function single(){
		static $single;
		if( empty( $single ) ) {
			$single = new DistinctiveThemes_SiteOrigin_Widget_Field_Class_Loader();
		}
	...
	public function extend(){
		$this->add_class_prefixes(
			apply_filters( 'distinctivethemes_widgets_field_class_prefixes', array() ),
			'base'
		);

		$this->add_class_paths(
			apply_filters( 'distinctivethemes_widgets_field_class_paths', array() ),
			'base'
		);
	}
}

add_action( 'init', array( DistinctiveThemes_SiteOrigin_Widget_Field_Class_Loader::single(), 'extend' ) );
