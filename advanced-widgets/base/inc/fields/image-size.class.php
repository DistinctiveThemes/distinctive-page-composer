...
/**
 * Class DistinctiveThemes_SiteOrigin_Widget_Field_Select
 */
class DistinctiveThemes_SiteOrigin_Widget_Field_Image_Size extends DistinctiveThemes_SiteOrigin_Widget_Field_Select {
	...
	protected function get_default_options() {
		...
		$sizes = array(
			'full' => __( 'Full', 'dapper-pro' ),
			'thumb' => __( 'Thumbnail (Theme-defined)', 'dapper-pro' ),
		);
