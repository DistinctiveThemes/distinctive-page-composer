 ...
 *
 * Class DistinctiveThemes_SiteOrigin_Widget_Field_Editor
 */
class DistinctiveThemes_SiteOrigin_Widget_Field_Editor extends DistinctiveThemes_SiteOrigin_Widget_Field_Text_Input_Base {
	/**
