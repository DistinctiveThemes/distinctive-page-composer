 ...
 */
function distinctivethemes_widgets_underscores_to_camel_case( $array ) {
	$transformed = array();
	if ( !empty( $array ) ) {
		foreach ( $array as $key => $val ) {
			$jsKey = preg_replace_callback( '/_(.?)/', 'distinctivethemes_widgets_match_to_upper', $key );
 ...
 * @return string
 */
function distinctivethemes_widgets_match_to_upper( $matches ) {
